...
Obviously, you should make sure to have a running [development environment](/docs/development.md) first.
...
Some tests require the [mock\_server](/tests/mock_server.php) to run.
It's automatically started if you use the Docker environment.
...
It takes one of the value of [the PHPUnit CLI options](https://phpunit.readthedocs.io/en/9.0/textui.html#textui-clioptions).
...
The test suite is automatically executed on pull requests with [GitHub Actions](https://github.com/flusio/Flus/actions).
