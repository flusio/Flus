...
class Notes extends BaseController
{
    ...
    public function index(Request $request): Response
    {
        ...
        return Response::json(200, array_map(function ($message): array {
    ...
    public function create(Request $request): Response
    {
        ...
        if (!auth\LinksAccess::canComment($user, $link)) {
            return Response::json(403, [
        ...
        if (!$message->validate()) {
            return $this->badRequest($message->errors(format: false));
        }

        $message->save();
        $link->refreshTags();

        return Response::json(200, $message->toJson());
    }
}
