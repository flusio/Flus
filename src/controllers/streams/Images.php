...
class Images extends BaseController
{
    ...
    public function edit(Request $request): Response
    {
        ...
        $form = new forms\streams\EditStreamImage();

        return Response::ok('streams/images/edit.html.twig', [
            'stream' => $stream,
            'form' => $form,
        ]);
    }
    ...
    public function update(Request $request): Response
    {
        ...
        if (!$form->validate()) {
            return Response::badRequest('streams/images/edit.html.twig', [
                'stream' => $stream,
                'form' => $form,
            ]);
        }
        ...
        $subpath = utils\Belt::filenameToSubpath($stream->id);
        ...
        if ($stream->image_filename) {
            @unlink($path_covers . $stream->image_filename);
        }

        $image_filename = "{$stream->id}.webp";
        $cover_image->save($path_covers . $image_filename);

        $stream->image_filename = $image_filename;
        $stream->save();
