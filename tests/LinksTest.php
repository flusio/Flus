...
class LinksTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testReadFailsIfLinkDoesNotExist()
    {
        ...
        $response = $this->appRun('post', "/links/not-an-id/read", [
            'csrf' => $user->csrf,
        ]);
    ...
    public function testReadLaterRemovesLinkFromNewsOnlyAndRedirects()
    {
        $links_to_collections_dao = new models\dao\LinksToCollections();
        $link_dao = new models\dao\Link();
        $user = $this->login();
    ...
    public function testReadLaterFailsIfLinkDoesNotExist()
    {
        ...
        $response = $this->appRun('post', "/links/not-an-id/read-later", [
            'csrf' => $user->csrf,
        ]);
